...
<div class="layui-layout layui-layout-admin">
    <div class="layui-header">
        ...
        <ul class="layui-nav layui-layout-left">
            ...
            <li class="layui-nav-item"><a onclick="changeIframe2('cache','config')">获取x-token</a></li>

            <li class="layui-nav-item"><a onclick="changeIframe('trigger')"></a></li>
    ...
    <div class="layui-body">
        ...
        <div style="padding: 15px;">
            <iframe src="${pageContext.request.contextPath}/WEB-INF/jsp/init.jsp" frameborder="0" id="1" style="width: 100%; height: 100%;"></iframe>
        </div>
...
<script>
    ...
    function changeIframe2(iframeName,module) {
        document.getElementById('1').setAttribute('src',"${pageContext.request.contextPath}"+"/"+iframeName+"/"+module);
    }
</script>
